...
- **Rule**: Avoid using `docker image prune` or `docker system prune` unless absolutely necessary (e.g., out of disk space) and with user consent. This is a last resort tool.
